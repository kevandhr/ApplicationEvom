...
public class SlideMenuContentView extends ViewGroup {
    ...
    private int mTouchMode = SlideMenuContainerLayout.TOUCHMODE_MARGIN;
    ...
    private boolean thisTouchAllowed(MotionEvent ev) {
        ...
        switch (mTouchMode) {
            case SlideMenuContainerLayout.TOUCHMODE_FULLSCREEN:
                return !isInIgnoredView(ev);
            case SlideMenuContainerLayout.TOUCHMODE_NONE:
                return false;
            case SlideMenuContainerLayout.TOUCHMODE_MARGIN:
                return x <= mEdgeWidth;
        }
        return false;
    }
