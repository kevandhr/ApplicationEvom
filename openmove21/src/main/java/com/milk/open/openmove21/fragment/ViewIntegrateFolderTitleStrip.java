...
import com.milk.open.openmove21.util.UtilDisplay;

import java.util.ArrayList;

public class ViewIntegrateFolderTitleStrip extends View implements
    ...
    public ViewIntegrateFolderTitleStrip(Context context, AttributeSet attrs,
                                         int defStyleAttr) {
        ...
        setTextSize(UtilDisplay.sp2px(getContext(),18));
