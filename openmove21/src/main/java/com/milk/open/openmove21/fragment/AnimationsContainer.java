...
//    private int[] mProgressAnimFrames = getData(resId);
    ...
    public static AnimationsContainer getInstance(int resId, int fps) {
        ...
        mInstance.resId = resId;
        mInstance.FPS = fps;
        return mInstance;
    }

    public static AnimationsContainer getInstance(int resId, int fps, Context mContext) {
        mInstance = AnimationsContainer.getInstance(resId, fps);
